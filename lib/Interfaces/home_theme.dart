...
Scaffold(
    ...
    bottomNavigationBar: bottom_navigation_bar(selectedindex: _selectedIndex,ontapped:_onItemTapped ,));
...
int selectedindex;
Function ontapped;
   bottom_navigation_bar({Key key,this.ontapped,this.selectedindex}) : super(key: key);
